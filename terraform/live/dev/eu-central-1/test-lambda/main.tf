...
resource "aws_secretsmanager_secret" "this" {
  name = "performance-data-rds-secret"
}
...
resource "aws_secretsmanager_secret_version" "this" {
  ...
  {
    "username": "bi",
    "password": "91edmw4hoRAQF6uW",
    "engine": "postgres",
    "host": "shared-postgres13-integration-1.c0lpqzwboqh6.eu-central-1.rds.amazonaws.com",
    "port": 5432,
    "dbClusterIdentifier": "shared-postgres13-integration"
  }
  EOF
}
...
module "rds_bastion" {
  source = "git@github.com:celver-AG/terraform-aws-ec2-instance?ref=0.1.5"
...
# data "aws_subnets" "public_staging" {
#   filter {
#     name   = "vpc-id"
...
# module "rds_bastion_staging" {
#   source = "git@github.com:celver-AG/terraform-aws-ec2-instance?ref=0.1.5"

#   instance_type          = "t2.micro"
#   ami                    = "ami-070b208e993b59cea"
#   subnet_id              = data.aws_subnets.public_staging.ids[0]
#   vpc_security_group_ids = [module.sg_rds_bastion_staging.id]
...
# module "sg_rds_bastion_staging" {
#   source = "git@github.com:celver-AG/terraform-aws-security-group.git?ref=0.1.3"

#   name   = "rds_bastion_staging"
